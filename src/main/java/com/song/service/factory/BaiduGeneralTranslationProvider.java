 ...
 * 百度通用文本翻译 API。
 */
public class BaiduGeneralTranslationProvider implements TranslationProvider {

    private static final Logger LOG = LoggerFactory.getLogger(BaiduGeneralTranslationProvider.class);
    private static final String API_URL = "https://fanyi-api.baidu.com/api/trans/vip/translate";

    @Override
    public ProviderType getType() { return ProviderType.BAIDU_GENERAL; }
